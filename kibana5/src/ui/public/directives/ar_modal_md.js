...
uiModules
  .get('kibana')
  .directive('arModalMd', function ($modal,$translate) {
    return {
      restrict: 'E',
      scope: {
        modalObj: '=',
        ...
        element.bind('mousedown', function () {
          ...
          var modalConfirmInstance = $modal.open({
            ...
            controller:['$scope','$modalInstance', function ($scope,$modalConfirmInstance) {
              ...
              $scope.title = scope.title || $scope.modalObj.title;//头部
              $scope.msg = scope.msg || $scope.modalObj.msg;//body信息
              $scope.ok = scope.ok || $scope.modalObj.ok;
