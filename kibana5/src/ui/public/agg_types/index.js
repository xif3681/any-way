...
import AggTypesMetricsMonitorProvider from 'ui/agg_types/metrics/monitor';
...
import AggTypesBucketsStartEndTimesProvider from 'ui/agg_types/buckets/start_end_times';
import AggTypesBucketsMonitorAnotherProvider from 'ui/agg_types/buckets/monitor_another';
export default function AggTypeService(Private) {
  ...
  let aggs = {
    metrics: [
      ...
      Private(AggTypesMetricsMonitorProvider),
    ],
    buckets: [
      ...
      Private(AggTypesBucketsStartEndTimesProvider),
      Private(AggTypesBucketsMonitorAnotherProvider)
    ]
  };
