...
export default function PointSeriesChartProvider(Private, $translate) {
  ...
  if (lang === 'zh-cn') {
    touchdownTmpl = _.template(require('ui/vislib/partials/touchdownCn.tmpl.html'));
  } else if (lang === 'zh-tw') {
    touchdownTmpl = _.template(require('ui/vislib/partials/touchdownTw.tmpl.html'));
  } else {
    touchdownTmpl = _.template(require('ui/vislib/partials/touchdownEn.tmpl.html'));
  }
