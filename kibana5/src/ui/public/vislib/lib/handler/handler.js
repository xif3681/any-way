...
export default function HandlerBaseClass(Private,$translate,$translatePartialLoader) {
  ...
  class Handler {
    ...
    error(message) {
      ...
      if (message === 'No results found') {
        ...
        .append('h4').text($translate.instant(message));

        div.append('div').attr('class', 'item bottom');
        return div;
      }

      return div.append('h4').text($translate.instant(message));
    };
