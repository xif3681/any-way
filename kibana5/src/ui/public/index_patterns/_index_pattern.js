...
export default function IndexPatternFactory(Private, Notifier, config, kbnIndex, Promise, safeConfirm,$translate,
  arSafeModalYes,arSafeModalNo) {
  ...
  class IndexPattern {
    ...
    createOpen() {
      ...
      .catch(err => {
        ...
        const confirmMessage = $translate.instant('Are you sure you want to overwrite this?');
        // const confirmMessage = 'Are you sure you want to overwrite this?';

        return arSafeModalNo(confirmMessage)
        .then(() => Promise
          .try(() => {
    ...
    createYes() {
      ...
      .catch(err => {
        ...
        return arSafeModalYes(confirmMessage)
        .then(() => Promise
          .try(() => {
            const cached = patternCache.get(this.id);
            if (cached) {
