...
import openRowHtml from 'ui/ar_doc_table/components/table_row/open.html';
import detailsHtml from 'ui/ar_doc_table/components/table_row/details.html';
 ...
 * ```
 */
module.directive('arTableRow', function ($compile) {
