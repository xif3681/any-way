...
import headerHtml from 'ui/ar_doc_table/components/ar_table_header.html';
import uiModules from 'ui/modules';
let module = uiModules.get('app/discover');


module.directive('arTableHeader', function (shortDotsFilter,$translate) {
    ...
    controller: function ($scope) {
      ...
      $scope.tooltip = function (column) {
        ...
        if (lang === 'en-us') {
          ...
          return '按' + shortDotsFilter(column) + '排序';
        }
        //return 'Sort by ' + shortDotsFilter(column);
      };
