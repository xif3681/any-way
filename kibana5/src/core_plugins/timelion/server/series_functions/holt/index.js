...
module.exports = new Chainable('holt', {
  args: [
    ...
    },
    {
      name: 'alpha',
      types: ['number'],
      help: 'Smoothing weight from 0 to 1. Increasing alpha will make the new series more closely follow the original. ' +
      'Lowering it will make the series smoother'
    },
    {
      name: 'beta',
      types: ['number'],
      help: 'Trending weight from 0 to 1. Increasing beta will make rising/falling lines continue to rise/fall longer. ' +
      'Lowering it will make the function learn the new trend faster'
    },
    {
      name: 'gamma',
      types: ['number'],
      help: 'Seasonal weight from 0 to 1. Does your data look like a wave? ' +
    ...
    },
    {
      name: 'sample',
      types: ['number', 'null'],
      help: 'The number of seasons to sample before starting to "predict" in a seasonal series. ' +
      '(Only useful with gamma, Default: all)'
    }
  ],
  help: 'Sample the beginning of a series and use it to forecast what should happen via ' +
  'several optional parameters. In general, like everything, this is crappy at predicting the ' +
