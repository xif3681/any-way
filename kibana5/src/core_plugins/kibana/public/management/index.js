...
uiModules
.get('apps/management')
.directive('kbnManagementApp', function (Private, $route, $location, timefilter, buildNum, buildSha,$translate, $translatePartialLoader) {
  $translatePartialLoader.addPart('../plugins/kibana/management/sections/log_group');
  $translate.refresh();
  return {
    restrict: 'E',
