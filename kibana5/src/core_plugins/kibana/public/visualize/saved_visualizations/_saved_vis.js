...
uiModules
.get('app/visualize')
.factory('SavedVis', function (config, $injector, courier, Promise, savedSearches, Private, Notifier,$translate) {
  //luochunxiang@eisoo.com
  var dashboardTitle;
  var lang = $translate.use();
  if (lang === 'zh-cn') {
    dashboardTitle = '新建可视化';
  } else if (lang === 'zh-tw') {
    dashboardTitle = '新建視覺化';
  } else {
    dashboardTitle = 'New Visualization';
  }
