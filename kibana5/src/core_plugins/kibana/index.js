  ...
  return new kibana.Plugin({
    ...
    config: function (Joi) {
      return Joi.object({
        ...
        defaultAppId: Joi.string().default('login'),
    ...
    uiExports: {
      ...
      links: [
        ...
        },
        {
          ...
          icon: 'plugins/kibana/assets/data.svg',
        ...
        },
        {
          ...
          title: 'Alarm',
          order: -1002,
          url: `${kbnBaseUrl}#/alarm`,
          description: 'define index patterns, change config, and more',
          icon: 'plugins/kibana/assets/alarm.svg',
          linkToLastSubUrl: false
        },
        {
          id: 'kibana:dashboard',
        ...
        },
        {
          ...
          title: 'Management',
          order: 1000,
          url: `${kbnBaseUrl}#/management/kibana/indices`,
          description: 'define index patterns, change config, and more',
